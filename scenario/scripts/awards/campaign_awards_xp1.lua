...
awards_group={
	...
	{flag_name="transportationcampaign", icon_name="TransportationCampaign_name_award", locid="TransportationCampaign", args={"vehiclegatelock"}},
	{flag_name="endangeredanimalcampaign", icon_name="EndangeredAnimalsCampaign_name_award", locid="EndangeredAnimalsCampaign", args={"breedingcenterlock"}},
	{flag_name="photosafaricampaign", icon_name="PhotoSafariCampaign_name_award", locid="PhotoSafariCampaign", args={"catclimberlock"}},
	test_func=checkcamp,
	-- the XML file that defines graphic for this awards group
	group_xml="awards/XP1_Campaign.xml",
