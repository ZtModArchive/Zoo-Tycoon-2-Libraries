...
function xaward(group, index)
	...
	local totaldon = totalIncomeOfStation("skystation") + totalIncomeOfStation("groundstation");
...
awards_group={
	...
	{flag_name="tourtycoonawardpart1", icon_name="TourTycoonOne", locid="TourTycoonOne", args={25000, "sixseaterlock"} },
	{flag_name="tourtycoonawardpart2", icon_name="TourTycoonTwo", locid="TourTycoonTwo", args={250000, "groundvehicleupgradelock"} },
	test_func=xaward,
	-- the XML file that defines graphic for this awards group
	group_xml="awards/TourTycoongroup.xml",
