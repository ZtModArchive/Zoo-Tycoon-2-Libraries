...
function xaward(group, index)
	...
	local totaltours = totalUsersOfStation("skystation") + totalUsersOfStation("groundstation");
	...
	awards_update_bar(group.group_xml, index, totaltours, amount)
	if (totaltours >= amount) then
...
awards_group={
	...
	{flag_name="transportationtycoonawardpart1", icon_name="TransportationTycoonOne", locid="TransportationTycoonOne", args={100, "twoseaterlock"} },
	{flag_name="transportationtycoonawardpart2", icon_name="TransportationTycoonTwo", locid="TransportationTycoonTwo", args={500, "fourseaterlock"} },
	{flag_name="transportationtycoonawardpart3", icon_name="TransportationTycoonThree", locid="TransportationTycoonThree", args={1000, "skytramlock"} },
	test_func=xaward,
	-- the XML file that defines graphic for this awards group
	group_xml="awards/TransportationTycoongroup.xml",
