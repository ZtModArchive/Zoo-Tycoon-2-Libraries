...
function xaward(group, index)
	...
	local totaldon = getDonations("Education")
...
awards_group={
	...
	{flag_name="educationaward", icon_name="Scholars", locid="Scholars", args={25000} },
	{flag_name="educationawardpart2", icon_name="EducationalDonationAchievement_award", locid="EducationalDonationAchievement", args={125000} },
	test_func=xaward,
	-- the XML file that defines graphic for this awards group
	group_xml="awards/ZooDonations.xml",
...
function postawardgroupcomplete()
	...
	setglobalvar("headphonelock", "true");
