...
function xaward(group, index)
	...
	local totalspecies =  table.getn(uniqueAfricanTable)
	...
	awards_update_bar(group.group_xml, index, totalspecies, amount)
	if (totalspecies >= amount) then
...
awards_group={
	...
	{flag_name="africatycoonaward", icon_name="AfricaTycoonOne", locid="AfricaTycoonOne", args={10, "AfricaJeeplock"} },
	test_func=xaward,
	-- the XML file that defines graphic for this awards group
	group_xml="awards/AfricaTycoongroup.xml",
