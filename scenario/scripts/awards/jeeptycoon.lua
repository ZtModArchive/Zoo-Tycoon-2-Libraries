...
function xaward(group, index)
	...
	local totaldon = totalIncomeOfStation("groundstation");
...
awards_group={
	...
	{flag_name="jeeptycoonawardpart1", icon_name="JeepTycoonOne", locid="JeepTycoonOne", args={15000, "libertylock"} },
	test_func=xaward,
	-- the XML file that defines graphic for this awards group
	group_xml="awards/JeepTycoongroup.xml",
