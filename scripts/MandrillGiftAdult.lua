function MandrillGiftAdult(args)
	if args ~= nil then
		    ...
		    if subjecthandle ~= nil then
				...
				if subject ~= nil then
					...
					local torsoName = subject:BFG_GET_ATTR_STRING("s_Torso")	   				   				
	   				...
	   				torsoObject.image = "entities/objects/Items/Gifts/Mandrill_Gift.dds"
					...
					local waistName = subject:BFG_GET_ATTR_STRING("s_Waist")	
	   				...
	   				waistObject.image = "entities/objects/Items/Gifts/Mandrill_Gift.dds"
