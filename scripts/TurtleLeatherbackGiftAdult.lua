TurtleLeatherbackGiftAdult = function(l_1_arg0)
      ...
      if l_1_1 ~= nil then
         ...
         if l_1_2 ~= nil then
            ...
            if l_1_3 ~= nil then
               ...
               l_1_4.layer = "decal0"
               l_1_4.image = "entities/objects/Items/Gifts/TurtleLeatherback_Gift.dds"
               ...
               l_1_6.layer = "decal0"
               l_1_6.image = "entities/objects/Items/Gifts/TurtleLeatherback_Gift.dds"
